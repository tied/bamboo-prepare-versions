...
public class KnownProjectBuilds {
    ...
    public void sort() {
        ...
        for (String key : branches.keySet()) {
            builds = branches.get( key );
            Collections.sort( builds, new VersionsComparator() );
            branches.put( key, builds );
        }
    }
}

// https://stackoverflow.com/questions/41198379/sorting-version-numbers
final class VersionsComparator implements Comparator<String> {
